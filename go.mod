...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/parquetexporter v0.41.0
...
require (
	...
	go.opentelemetry.io/collector/model v0.41.1-0.20220105191026-60823e25df1c // indirect
